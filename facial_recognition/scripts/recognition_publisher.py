...
face_proto = "/home/collab/collab_ws/src/facial_recognition/scripts/deploy.prototxt"  
face_model = "/home/collab/collab_ws/src/facial_recognition/scripts/res10_300x300_ssd_iter_140000.caffemodel" 
...
path = '/home/collab/collab_ws/src/facial_recognition/scripts'
...
checkpoint = torch.load('/home/collab/collab_ws/src/facial_recognition/scripts/model_PAcc0.6471_NAcc0.9756.pth')
...
class FaceRecognitionPublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Int32, 'recognition_status', 10)

    def publish_status(self, status: int):
        msg = Int32()
        msg.data = status
        self.publisher_.publish(msg)
        #self.get_logger().info(f'Published recognition status: {msg.data}')

ros_node = FaceRecognitionPublisher()


MASTER_PASSWORD = "admin123"  
valid_path = '/home/collab/collab_ws/src/facial_recognition/scripts/operators'
...
def update_frame():
    ...
    if publish:
        ros_node.publish_status(1)
    else:
        ros_node.publish_status(0)
